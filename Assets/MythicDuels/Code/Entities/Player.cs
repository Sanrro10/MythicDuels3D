...
public class Player : Entity
{
    ...
    [Header("Stats")]
    [SyncVar] public int maxLevel = 20;
    [SyncVar] public int currentMax = 0;
    [SyncVar] public int _level = 0;
    public int mana
    {
        get { return Mathf.Min(_level, maxLevel); }
        set { _level = Mathf.Clamp(value, 0, maxLevel); }
    }
