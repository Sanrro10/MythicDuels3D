...
public class Deck : NetworkBehaviour
{
    ...
    {
        CharacterCard character = (CharacterCard)card.data;
    ...
    {
        if (player.mana < player.maxLevel)
        {
            player.currentMax++;
    ...
    public void RpcPlayCard(GameObject boardCard, int index)
    {
        if (Player.gameManager.isSpawning)
        {
            ...
            boardCard.GetComponent<MinionDisplay>().casterType = Target.FRIENDLIES;
        ...
        {
            boardCard.GetComponent<MinionDisplay>().casterType = Target.ENEMIES;
