...
public class PlayerHand : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (IsEnemyHand())
        {
            ...
            {
                CardDisplay slot = handContent.GetChild(i).GetComponent<CardDisplay>();
    ...
    public void AddCard(int index)
    {
        ...
        CardDisplay slot = cardObj.GetComponent<CardDisplay>();

        slot.SetCard(card.data, index, playerType);
    }
